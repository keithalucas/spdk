...
/**
 * Get the cluster index of a shallow copy operation

 * If a shallow copy of the blob is in progress, this functions returns the actual cluster
 * index under copy
 *
 * \param blob Blob struct to query.
 *
 ...
 */
uint64_t spdk_blob_get_shallow_copy_cluster_index(struct spdk_blob *blob);
