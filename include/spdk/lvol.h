...
/**
 * Change the parent of a lvol
 *
 * This call set a snapshot as the parent of a lvol, making the lvol a clone of this snapshot.
 * The previous parent of the lvol can be another snapshot or an external snapshot, if the lvol
 * is not a clone must be thin-provisioned.
